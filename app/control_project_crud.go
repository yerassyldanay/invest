...
var CreateProject = func(w http.ResponseWriter, r *http.Request) {
	...
	*/
	...
	var msg = is.ServiceCreateProject(&projectWithFinTable)
...
var GetProjectByProjectId = func(w http.ResponseWriter, r *http.Request) {
	...
	// parameters
	var projectId = service.GetQueryParameterUint64(r, "project_id", 0)
	var project = model.Project{Id: projectId}
	...
	*/
	msg := is.ProjectGetById(projectId)
