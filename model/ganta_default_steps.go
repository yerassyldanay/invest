...
var DefaultGantaChildren1 = []Ganta{
	...
	{
		IsAdditional:  false,
		Kaz:           "Справка об отсутствии обременения на имущество, передаваемое в совместный с СПК проект\n(при наличии)",
		Rus:           "Справка об отсутствии обременения на имущество, передаваемое в совместный с СПК проект\n(при наличии)",
		Eng:           "Справка об отсутствии обременения на имущество, передаваемое в совместный с СПК проект\n(при наличии)",
		StartDate:     utils.GetCurrentTime(),
		DurationInHours:      3,
		GantaParentId: 0,
		Status:        utils.ProjectStatusInprogress,
